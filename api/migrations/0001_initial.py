# Generated by Django 3.1 on 2020-12-10 11:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startdate', models.DateTimeField(auto_now=True, verbose_name='Дата начала действия записи')),
                ('enddate', models.DateTimeField(null=True, verbose_name='Дата окончания действия записи')),
                ('budget', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='glavs', to='api.budget', verbose_name='Бюджет')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'Актуальная запись'), (0, 'Архивная запись')], default=1, max_length=1, verbose_name='Статус записи')),
                ...
                ('code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='statuses', to='api.budget')),
                ('parentcode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='api.budget', verbose_name='Вышестоящий бюджет')),
            ],
            options={
